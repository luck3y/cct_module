...
Feature: Openshift EAP common tests (EAP and EAP derived images)
  ...
  @ignore  @jboss-decisionserver-6 @jboss-processserver-6
  ...
  Scenario: Management interface is secured (no warning message)
   ...
   @jboss-eap-7 @jboss-decisionserver-6 @jboss-processserver-6 @redhat-sso-7 @jboss-eap-7-tech-preview
  ...
  # test readinessProbe and livenessProbe (CLOUD-612)
   @jboss-eap-7 @jboss-decisionserver-6 @jboss-processserver-6 @jboss-kieserver-6 @jboss-eap-7-tech-preview
  ...
  Scenario: readinessProbe runs successfully
   ...
   @jboss-eap-7 @redhat-sso-7 @jboss-eap-7-tech-preview
  ...
  Scenario: Check if dns ping protocol is used when specified
   ...
   @jboss-eap-7 @jboss-decisionserver-6 @jboss-processserver-6 @jboss-eap-7-tech-preview
  Scenario: Check if jolokia is configured correctly
   ...
   @jboss-eap-7 @redhat-sso-7 @jboss-eap-7-tech-preview @jboss-datavirt-6/datavirt63-openshift @jboss-datavirt-6/datavirt64-openshift
  ...
  # Disabling @redhat-sso-7 for now - needs to be adjusted for EAP 7
   @jboss-decisionserver-6 @jboss-processserver-6 @jboss-datagrid-6/datagrid65-openshift
  ...
  @jboss-eap-7  @redhat-sso-7 @jboss-datavirt-6 @jboss-eap-7-tech-preview
  ...
  @jboss-eap-7  @redhat-sso-7 @jboss-datavirt-6 @jboss-datagrid-6 @jboss-datagrid-7 @jboss-processserver-6 @jboss-decisionserver-6 @jboss-eap-7-tech-preview
